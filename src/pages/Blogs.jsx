...
const Blogs = () => {
  ...
  return (
    <BlogStyled>
      <HomeLinkWrapper>
        <GoToHome><HomeIcon onClick={() => navigate("/home")} style={{ color:'var(--dark)',cursor: "pointer" }} /><p className='text'>部落格</p></GoToHome>
      </HomeLinkWrapper>
      <Breadcrumb />
      <BlogContent>
        <BlogListWrapper>
        ...
        <BlogAside>
          <div className='BlogArticalInner'>
            <BlogSearch>
                ...
                <form>
                  <input className='formStyled' type='text' placeholder="搜尋文章"/>
                </form>
            </BlogSearch>
            <BlogNews>
              <h4>
                ...
                <BlogArticalList>
                  <li className='articalContent'>
                    <h6>貓咪大便很臭怎麼辦？一篇瞭解貓便便臭原因以及毛球症對貓咪的影響</h6>
                    <ul className='DateCategory'>
                      <li className='BlogDate'><ClockIcon/>01 Jan, 2021</li>
                    </ul>
                  </li>
                  <li className='articalContent'>
                    <h6>【化毛粉怎麼吃總整理】食用頻率、餵食方法等常見問題一次解答</h6>
                    <ul className='DateCategory'>
                      <li className='BlogDate'><ClockIcon/>06 Jan, 2023</li>
                    </ul>
                  </li>
                  <li className='articalContent'>
                    <h6>狗狗突然禿一塊毛怎麼辦？狗狗掉毛原因與改善日常掉毛的4個方法分享</h6>
                    <ul className='DateCategory'>
                      <li className='BlogDate'><ClockIcon/>15 Sep, 2022</li>
                    </ul>
                  </li>
                </BlogArticalList>
            </BlogNews>
